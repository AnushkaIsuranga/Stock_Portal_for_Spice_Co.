...
INSERT INTO `stock_table` (`product_id`, `stock_type`, `available_stock`) VALUES
(1, 'Pepper', 4);
...
INSERT INTO `users_table` (`User_ID`, `Email`, `F_Name`, `L_Name`, `U_Name`, `NIC`, `Tel_No`, `Password`, `Role`) VALUES
...
(9, '123@ab4.com', 'ab4', 'ab4', 'ab4', '234', '+94714055002', '$2y$10$r9fBXd7i4nMGP/U.nrw.CeT8qa3kGV1wpnxNGCekBNkgSh9htNRqW', ''),
(11, 'inoka.kandy@gmail.com', 'abc', 'abc', 'Ms. Inoka', '123', '+94777807383', '$2y$10$74QoYQv3zHOGkNrG2wWT.ObdjfcwTapTZh..hTYIIGuRi0pELC4ci', '');
